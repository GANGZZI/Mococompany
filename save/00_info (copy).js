  ...
  async execute(interaction) {
    ...
    try {
      const exampleEmbed = new MessageEmbed()
        ...
        .addFields(
          { name: '/멤버', value: '모코콤퍼니 멤버 리스트', inline: true },
          { name: '/입사', value: '모코콤퍼니 입사 처리', inline: true },
          { name: '/등록', value: '사원의 캐릭터 등록 기능', inline: true },
        )
        .addFields(
        ...
        .addFields(
          ...
          { name: '/떠상', value: '지역별 떠돌이 상인 상세 위치를 알려줍니다.', inline: true },
          { name: '/시너지', value: '시너지 정보를 알려줍니다.', inline: true },
          { name: '/컨닝', value: '레이드 컨닝페이퍼를 띄워줍니다.', inline: true },
          { name: '/문의', value: '모코콤퍼니 봇 담당자에 문의 내용 전달', inline: false })
